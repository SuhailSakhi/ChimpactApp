...
import { runnerShopItems, ShopItem } from "../data/shopItems";
import { useRouter } from "expo-router";

export default function RunnerShopScreen() {
        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.footer}>
                    <TouchableOpacity style={styles.footerButton} onPress={() => router.push("/runner")}>
                        <Text style={styles.footerText}>Map</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.footerButton} onPress={() => router.push("/runnerchallenges")}>
